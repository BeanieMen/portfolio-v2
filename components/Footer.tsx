...
export default function Footer() {
  return (
    <footer id="contact" className="relative mt-10 w-[95vw] max-w-[95vw] overflow-hidden rounded-2xl border-[1px] border-panel-border bg-background/75 px-4 pb-32 pt-10 backdrop-blur-sm sm:px-6 lg:px-10">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3 md:gap-x-20 items-start">
      ...
      <div className="relative z-10 mt-6 flex items-center justify-center gap-8 border-t border-panel-border pt-5 text-sm text-text-muted">
        <span>Built by Beanie</span>
        <span>Delhi, India</span>
      </div>

      <div className="pointer-events-none absolute bottom-[-10%] left-1/2 z-0 w-full -translate-x-1/2 select-none px-4 text-center sm:px-6 lg:px-10">
        <p className="whitespace-nowrap text-center text-[clamp(4.8rem,18vw,16rem)] font-semibold leading-none tracking-tight text-[#dddcc4] dark:text-[#d8d8bf]/95">
          Beanie
        </p>
      </div>
    </footer>
